/* ==================================================================
 * MultiThreadIoEventLoopGroupFactoryTests.java - 12/03/2026 12:08:36 pm
 *
...
/**
 * Test cases for the {@link MultiThreadIoEventLoopGroupFactory} class.
 *
 * @author matt
 * @version 1.0
 */
public class MultiThreadIoEventLoopGroupFactoryTests {

	@Test
	public void constructed() throws Exception {
		// WHEN
		final MultiThreadIoEventLoopGroupFactory factory = new MultiThreadIoEventLoopGroupFactory();
	...
	public void staticInstance() throws Exception {
		// WHEN
		final EventLoopGroup result = MultiThreadIoEventLoopGroupFactory.INSTANCE.apply(null, null);
