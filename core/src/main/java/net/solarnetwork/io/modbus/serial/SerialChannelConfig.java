/* ==================================================================
 * SerialChannelConfig.java - 2/12/2022 6:33:26 am
 *
 ...
 * @version 1.0
 */
public interface SerialChannelConfig extends ChannelConfig, SerialParameters {
	 ...
	 */
	default SerialChannelConfig setSerialParameters(SerialParameters serialParameters) {
	 ...
	 * @return this instance
	 */
	SerialChannelConfig setParity(SerialParity parity);
	 ...
	 */
	SerialChannelConfig setWaitTime(int waitTime);
	 ...
	 * @return this instance
	 */
	SerialChannelConfig setReadTimeout(int readTimout);
